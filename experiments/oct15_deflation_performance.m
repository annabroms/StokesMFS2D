...
[FT_mu,lambda, it_res_mu, gmres_tol, err_res_mu] = solve_2D_res_lr(q,U,W,rad,images,lr,visualise);
[FT,lambda, it_res, gmres_tol, err_res] = solve_res_1B(q,U,W,rad,images,lr,visualise);
[FT2,lambda2, it_res2, gmres_tol, err_res2] = solve_res_1B(q,U,W,rad,images,0,visualise);
FT = rand(1,P*3); 
