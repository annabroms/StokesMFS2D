function lambda_fine = applyQmat_peanut_mob(mu,rvec_in,rvec_out,Sinv,Zi,Yi,opt,...
    rbase_in_c,rbase_in_f,refine,rimage_vec,nimage,q,UU,YY,L,pairs,UB_all,YB_all,UC_all, YC_all,Cmap,Lc_pair,Lf_pair)
%APPLYQMAT  Apply long-range preconditioning projection matrix on sources
%
%   lambda_fine = APPLYQMAT_PEANUT_MOB(vel, rvec_in, rvec_out, Sinv, Zi, Yi, opt)
%
...
%
%   See also: applyPmat, getCoarseMu, get_long_range_precond_mob,
%   getVelocityField
%
% Anna Broms, Nov 8, 2025
...
proj_vel = matvec_mob_pairprecond_peanut(mu,rbase_in_c,rbase_in_f,rvec_in,refine,rimage_vec,nimage,opt,rvec_out,rvec_out,q,UU,YY,L,pairs,UB_all,YB_all,UC_all, YC_all,Cmap,Lc_pair,Lf_pair);
