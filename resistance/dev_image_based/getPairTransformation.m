    ...
    if ~isempty(neigh)
        ...
        for k = 1:size(neigh,1)
            ...
            if two_parts
                ...
                tau_stress_x{i,p2} = tau_mapped(t_ind_x) + tau_mapped2(t_ind_x);
                tau_stress_y{i,p2} = tau_mapped(t_ind_y) + tau_mapped2(t_ind_y);
    
                tau_pot_x{i,p2} = tau_mapped(p_ind_x) + tau_mapped2(p_ind_x);
                tau_pot_y{i,p2} = tau_mapped(p_ind_y) + tau_mapped2(p_ind_y);
