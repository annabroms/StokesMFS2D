function [tau_stokes_x,tau_stokes_y,rot,tau_stress_x,tau_stress_y,tau_pot_x,tau_pot_y] = getTransformedDensityCoarse(tau,rimage,Uii,Yii,K,P,N_small,PM,pairs,s,ver)
