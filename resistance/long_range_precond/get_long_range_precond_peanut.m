...
for k = 1:P
    ...
    for i = 1:db
        ...
        res = matvec_2D_pairprecond_peanut(mu,rbase_in_c,rbase_in_f,rin,rbase_out_f,refine,rimage_vec,nimage,opt,rout,q,UU,YY,pairs,UB_all,YB_all,UC_all, YC_all,Cmap,0);
        Vmat(:,db*(k-1)+i) = res;
    end
