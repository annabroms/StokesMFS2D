function res = matvec_2D_Stokes_coarse(tau,rvec_in,rvec_out,rimage,nimage,q,Uii,Yii,K,pairs,s)
...
%coarse sources in rvec_in enhanced with images stored in rimage. The
%solution is expected to be in the range of the matrix K
...
[tau_stokes_x,tau_stokes_y,rot,tau_stress_x,tau_stress_y,tau_pot_x,tau_pot_y] = getTransformedDensityCoarse(tau,rimage,Uii,Yii,K,P,N_small,PM,pairs,s);
