function [FT,lambda,it,gmres_tol,maxres] = solve_res_precond_images(q,U,W,rads,delta_pair,lr,visualise,gmres_tol,debug)
...
%GMRES params
maxit = 800; 
solver_name = 'solve_res_precond_images';
