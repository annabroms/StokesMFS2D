function [tau_stokes_x, tau_self_x, tau_beta_x,tau_stokes_y,tau_self_y,tau_beta_y,u_corr] = transform_peanut(tau,rbase_in_c,rbase_in_f,rbase_out_f,refine,rimage_vec,nimage,opt,rvec_out,rcheck_out,q,U,Y,pairs,Upf,Ypf,DC_all, YC_all,Cmap,exterior,debug)
