...
\tikzset{
  ...
  mar26 number/.style={font=\marTwentySixNumberFont\ttfamily,text=black,anchor=center,inner sep=0pt,outer sep=0pt,text height=1.5ex,text depth=0.25ex},
  mar26 neighbour number/.style={font=\marTwentySixNumberFont\ttfamily,text={rgb,1:red,0.55;green,0.55;blue,0.55},anchor=center,inner sep=0pt,outer sep=0pt,text height=1.5ex,text depth=0.25ex}
}

\begin{document}
\begin{tikzpicture}
  \node[inner sep=0pt,outer sep=0pt] (img) at (0,0) {%
    \includegraphics{mar26_visualse_coarse_fine_fig3.pdf}%
  };
  \input{mar26_visualse_coarse_fine_fig3_annotations.tex}
\end{tikzpicture}
\end{document}
